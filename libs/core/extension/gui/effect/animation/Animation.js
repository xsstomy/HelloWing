    ...
    (function (gui) {
        var Animation = (function () {
            ...
            Animation.addAnimation = function (animation) {
                ...
                Animation.intervalTime = gui.Timeline.currentTime;
            ...
            Animation.timerHandler = function (event) {
                var oldTime = Animation.intervalTime;
                Animation.intervalTime = gui.Timeline.pulse();
                var n = Animation.activeAnimations.length;
                var i = 0;
                ...
                while (Animation.delayedStartAnims.length > 0) {
                    ...
                    if (animStartTime < gui.Timeline.currentTime)
            ...
            Animation.prototype.addToDelayedAnimations = function (timeToDelay) {
                ...
                var animStartTime = gui.Timeline.currentTime + timeToDelay;
                var insertIndex = -1;
                for (var i = 0; i < Animation.delayedStartAnims.length; ++i) {
            ...
            Animation.prototype.pause = function () {
                if (this.delayedStartTime >= 0) {
                    this.delayTime = this.delayedStartTime - gui.Timeline.currentTime;
                    this.removeFromDelayedAnimations();
                }
                this._isPlaying = false;
            };
            ...
            Animation.prototype.start = function (event) {
                ...
                if (!this.playReversed && this.delayedStartTime >= 0) {
                    var overrun = gui.Timeline.currentTime - this.delayedStartTime;
                    if (overrun > 0)
